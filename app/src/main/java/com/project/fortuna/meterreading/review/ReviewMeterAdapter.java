...
public class ReviewMeterAdapter extends BaseAdapter {
    ...
    public ReviewMeterAdapter(Activity activity, List<TbBacaMeter> listMeter) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null)
            convertView = inflater.inflate(R.layout.activity_review_meter_adapter, parent, false);
